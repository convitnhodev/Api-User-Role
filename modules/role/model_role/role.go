...
type Role struct {
	...
	Permissions     []Permission `json:"permissions" gorm:"many2many:role_permission;joinForeignKey:role_code;References:permission_code;joinReferences:permission_code"`
}
